...
const Header = () => {
    ...
    return(
                <Navbar className="bg-secondary bg-gradient fixed-top">
                    ...
                    <img src={"http://localhost:8000/api/images/" + loggedUser1.imageKey} alt="" className="avatar avatar-sm d-none d-sm-inline-block rounded-circle mr-2" style={{height:"45px",width:"45px"}}  />
